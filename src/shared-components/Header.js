...
import { deviceType } from "../utilits"
                ...
                <Link className="menu-logo-icon" to={"portfolio"}>
                  <svg className="logo-sd" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 138.37 162.25">
                    <g>
                      ...
                      <rect className="logo-sd-1" x="42.04" y="-34.49" width="0.17" height="84.25" transform="translate(34.49 49.76) rotate(-90)"/>
                      <rect className="logo-sd-1" x="38.27" y="77.03" width="0.17" height="76.71" transform="translate(-77.03 153.74) rotate(-90)"/>
                      <rect className="logo-sd-1" x="95.16" y="111.54" width="0.17" height="86.25" transform="translate(-59.42 249.91) rotate(-90)"/>
                      <rect className="logo-sd-1" x="84.53" y="6.79" width="0.17" height="107.5" transform="translate(24.08 145.16) rotate(-90)"/>
                      <rect className="logo-sd-1" x="130.72" y="52.33" width="0.17" height="109.92"/>
                      <rect className="logo-sd-1" x="77.94" y="34.77" width="0.17" height="99.21" transform="translate(46.34 -26.09) rotate(26.76)"/>
                      <rect className="logo-sd-1" x="56.35" y="36.77" width="0.17" height="99.21" transform="translate(43.85 -16.03) rotate(26.15)"/>
